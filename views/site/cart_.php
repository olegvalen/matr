                            ...
                            <?php foreach ($carts as $item): ?>
                                <tr class="first odd">
                                            ...
                                            <select name="size_id" class="size-option"
                                                ...
                                                <?php foreach ($item['options'] as $option): ?>
                                                    <option value="<?= $option->attribute_id ?>"
                                                        ...
                                                        (<?= Yii::$app->formatter->asInteger($option->value) ?> грн.)
                                                    </option>
                                                <?php endforeach; ?>
                                            </select>
                                        </h2>
                                    ...
                                    <td class="a-center last">
                                        <a href="<?= Url::to(['wishlist/clear', 'id' => $item['cart']->product->product_id]) ?>"
                                           title="Удалить" class="btn-remove btn-remove2" data-id="<?= $item['cart']->product->product_id ?>">
